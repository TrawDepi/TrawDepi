...
<head>
    ...
    <h1>Bienvenue sur la page d'aministration du site</h1>
  ...
  xhttp.open("GET", "ListeEtudiant.php?name=" +escape(name) + "&id=" +escape(id) +
...
<body>
    ...
    <table class="t2">
        <tr>
        <th class="t2" id="formu" colspan="7">Formulaire de Recherche</th>
        <br>
        </tr>
        <tr class="champ">
    ...
    </br><a href='ajouter.php'>Ajouter un nouveau etudiant</a>
</body>
</html>